classdef Elitism < jku.ga.operators.BaseReplacement
    ...
    methods(Access = protected)
        function replacedPopulation = ReplacementImplementation(this, previousPopulation, crossedPopulation, mutatedPopulation, maxIndividuals)
            ...
            replacedPopulation = jku.ga.Population([previousPopulation.Individuals, crossedPopulation.Individuals, mutatedPopulation.Individuals]);
            replacedPopulation = replacedPopulation.OrderByFitness();
            replacedPopulation = jku.ga.Population(replacedPopulation.Individuals(1:maxIndividuals));
        end
    end 
end