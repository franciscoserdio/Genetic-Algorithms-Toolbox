classdef IndividualFactory < jku.matlab.system.HiddenHandle
    ...
    methods
        function this = IndividualFactory(factoryArgs)
            % Creates a jku.ga.IndividualFactory instance.
            %
            % factoryArgs: the jku.ga.IndividualFactoryArgs parametrizing how the individuals are created.
            %
            % @return this: The jku.ga.IndividualFactory instance.
    ...
    methods(Access = private)       
        function population = CreateRandomPopulation(this, populationSize)
            ...
            population = jku.ga.Population(tempPopulation(randperm(populationSize)));
        end
     end
    ...
    methods(Access = protected)       
        function population = CreateCustomPopulation(this, populationSize)
            ...
            error('jku:DefaultImplementation', 'There is no implementation for "createCustomPopulation". \n');
        end
    end
