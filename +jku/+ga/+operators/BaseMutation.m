classdef BaseMutation < jku.ga.operators.BaseOperator
    % BASEMUTATION: Determines how an individual is mutated.

    methods
        function this = BaseMutation()
            % Creates a jku.ga.operators.BaseMutation instance.
            %
            %  @return this: The new jku.ga.Operators.BaseMutation instance.
    ...
    methods(Access = public)
        function mutatedPopulation = ApplyMutation(this, population, mutationRate)
            ...
            mutatedPopulation = jku.ga.Population(mutatedIndividuals);
        end
    end    
