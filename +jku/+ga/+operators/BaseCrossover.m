classdef BaseCrossover < jku.ga.operators.BaseOperator
    % BASECROSSOVER: Determines how two individuals crossover in order to produce offsprings.

    methods
        function this = BaseCrossover()
            % Creates a jku.ga.operators.BaseCrossover instance.
            %
            %  @return this: The new jku.ga.Operators.BaseCrossover instance.
    ...
    methods(Access = public)
        function crossedPopulation = ApplyCrossover(this, population, crossoverRate)
            ...
            crossedPopulation = jku.ga.Population(crossedIndividuals);
        end
    end
