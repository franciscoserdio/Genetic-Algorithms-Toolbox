classdef Population < jku.matlab.system.IClonable & jku.matlab.system.HiddenHandle
    ...
    methods
        function this = Population(individuals)
            % Creates a jku.ga.Population instance.
            %
            % @param individuals: The individuals of the population.
            %
            % @return this: The jku.ga.Population instance.
    ...
    methods(Access = public)
        function [orderedPopulation, indexes] = OrderByFitness(this)
            ...
            orderedPopulation = jku.ga.Population(orderedIndividuals);
        end
        ...
        function population = Clone(this)
            ...
            population = jku.ga.Population(tempIndividuals);
        end
    end
