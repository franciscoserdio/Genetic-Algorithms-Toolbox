classdef BaseReplacement < jku.ga.operators.BaseOperator
    ...
    methods
        function this = BaseReplacement()
            % Creates a jku.ga.operators.BaseReplacement instance.
            %
            %  @return this: The new jku.ga.Operators.BaseReplacement instance.
